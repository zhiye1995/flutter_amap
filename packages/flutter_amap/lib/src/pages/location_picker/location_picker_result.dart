...
class LocationPickerResult {
  ...
  factory LocationPickerResult.fromInputTip(
    ...
    return LocationPickerResult(
      position: position,
      name:
          _locationPickerEmptyToNull(inputTip.name) ??
          _locationPickerEmptyToNull(poi?.name),
      address:
          _locationPickerEmptyToNull(inputTip.address) ??
          _locationPickerEmptyToNull(poi?.address),
      poiId:
          _locationPickerEmptyToNull(inputTip.poiId) ??
  ...
  factory LocationPickerResult.fromCurrentLocation({
    ...
    final poi = reGeocode?.pois.isNotEmpty == true
        ? reGeocode!.pois.first
        : null;
    return LocationPickerResult(
      position: position,
  ...
  RoutePoint toRoutePoint() {
    return RoutePoint(position: position, name: name, poiId: poiId);
  }
}
