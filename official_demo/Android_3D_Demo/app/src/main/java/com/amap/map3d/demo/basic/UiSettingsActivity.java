...
public class UiSettingsActivity extends Activity implements
	...
	public void onClick(View view) {
		...
		} else if (id == R.id.scale_toggle) {//设置地图默认的比例尺是否显示
			mUiSettings.setScaleControlsEnabled(((CheckBox) view).isChecked());
		} else if (id == R.id.zoom_toggle) {//设置地图默认的缩放按钮是否显示
		...
		} else if (id == R.id.compass_toggle) {//设置地图默认的指南针是否显示
			mUiSettings.setCompassEnabled(((CheckBox) view).isChecked());
		} else if (id == R.id.mylocation_toggle) {//设置地图默认的定位按钮是否显示
