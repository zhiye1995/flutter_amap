...
class _MapZoomRestrictionPageState extends State<MapZoomRestrictionPage> {
  ...
  Widget build(BuildContext context) {
    final minZ = _limitZoom
        ? MapZoomRestrictionPage.restrictedMinZoom
        : MapZoomRestrictionPage.sdkMinZoom;
    final maxZ = _limitZoom
        ? MapZoomRestrictionPage.restrictedMaxZoom
        : MapZoomRestrictionPage.sdkMaxZoom;
