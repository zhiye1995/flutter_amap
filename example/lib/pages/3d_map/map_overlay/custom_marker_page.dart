            ...
            child: AMapWidget(
              ...
              onMarkerClick: (id) {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(content: Text('onMarkerClick: $id')),
                );
              },
            ),
          ),
...
class _MotoMarkerPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, ui.Size size) {
    ...
    canvas.drawCircle(rear, rWheel * 0.45, Paint()..color = const Color(0xFFB0BEC5));
    canvas.drawCircle(front, rWheel * 0.45, Paint()..color = const Color(0xFFB0BEC5));
